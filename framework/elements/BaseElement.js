...
export default class BaseElement {
   ...
   */
  async _click({ byJS, isQuick } = { byJS: false, isQuick: false }) {
   ...
   */
  async click() {
    return this._click({ byJS: false, isQuick: false });
  }

  /**
   * Click on element without waiting element to be clickable
   * @returns {Promise<void>}
   */
  async quickClick() {
    return this._click({ byJS: false, isQuick: true });
  }
   ...
   */
  async clickByJS() {
    return this._click({ byJS: true, isQuick: false });
  }
